...
class editar_orbitantes extends StatefulWidget {

  Orbitantes orbitante;

  editar_orbitantes({this.orbitante});

  @override
  _editar_orbitantesState createState() => _editar_orbitantesState();
}

class _editar_orbitantesState extends State<editar_orbitantes> {
  @override
  ...
  void validarCampos() async{
    ...
    if((hintSatelite == "Satélites Naturais" && hintEstrela == "Estrelas") ||
      ...
      Fluttertoast.showToast(
        ...
        (widget.orbitante.sateliteNatural.id != selectedSatellite.id
            || widget.orbitante.planeta.id != selectedPlanet.id
            || widget.orbitante.estrela.id != selectedStar.id)){
      Fluttertoast.showToast(
      ...
      Navigator.pushNamed(context, "/exibir_orbitantes", arguments: widget.orbitante);
    }
  }
                ...
                StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot){
                    if(!snapshot.hasData){
                      ...
                      if(widget.orbitante.planeta.id == "-" && hintPlaneta == "Planetas"){
                        selectedPlanet = aux;
                      }
                      ...
                      for(Planeta item in listaPlanetas){
                        if(item.id == widget.orbitante.planeta.id && hintPlaneta == widget.orbitante.planeta.nome){
                          selectedPlanet = item;
                        }
                        itens.add(
                            DropdownMenuItem(
                ...
                StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot){
                    if(!snapshot.hasData){
                      ...
                      if(widget.orbitante.estrela.id == "-" && hintEstrela == "Estrelas"){
                        selectedStar = aux;
                      }
                      ...
                      for(Estrela item in listaEstrelas){
                        if(item.id == widget.orbitante.estrela.id && hintEstrela == widget.orbitante.estrela.nome){
                          selectedStar = item;
                        }
                        itens.add(
                            DropdownMenuItem(
                ...
                StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot){
                    if(!snapshot.hasData){
                      ...
                      if(widget.orbitante.sateliteNatural.id == "-" && hintSatelite == "Satélites Naturais"){
                        selectedSatellite = aux;
                      }
                      ...
                      for(SateliteNatural item in listaSatelites){
                        if(item.id == widget.orbitante.sateliteNatural.id && hintSatelite == widget.orbitante.sateliteNatural.nome){
                          selectedSatellite = item;
                        }
                        itens.add(
                            DropdownMenuItem(
                                value: item,
