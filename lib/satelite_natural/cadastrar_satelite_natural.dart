...
class cadastrar_satelite_natural extends StatefulWidget {
  @override
  _cadastrar_satelite_naturalState createState() => _cadastrar_satelite_naturalState();
}

class _cadastrar_satelite_naturalState extends State<cadastrar_satelite_natural> {
  ...
  void validarCampos(){
    ...
    if(nome.isEmpty || tamanho.isEmpty || massa.isEmpty || componentes.length == 0){
      Fluttertoast.showToast(
        msg: "Preencha todos os campos.",
        toastLength: Toast.LENGTH_LONG,
        gravity: ToastGravity.BOTTOM,
      ...
      sateliteNatural.nome = _nomeController.text;
      sateliteNatural.tamanho = double.tryParse(_tamanhoController.text);
      sateliteNatural.massa = double.tryParse(_massaController.text);
      sateliteNatural.componentes = componentes;
      sateliteNatural.adicionarSateliteNatural();
      Fluttertoast.showToast(
        msg: "Satélite natural cadastrado com sucesso!",
        toastLength: Toast.LENGTH_LONG,
        gravity: ToastGravity.BOTTOM,
      );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          elevation: 0,
          title: Text("Cadastrar Satélite Natural"),
        ),
